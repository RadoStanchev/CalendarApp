...
BEGIN
    ...
    JOIN dbo.Users c ON c.Id = mp.ContactId -- Join with Users to get name/email
    JOIN dbo.Meetings m ON m.Id = mp.MeetingId -- Join with Meetings to find the creator
